...
const HIGH_PROFILE_BRANDS = [
  ...
  { name: 'Facebook', primaryDomain: 'facebook.com', keywords: ['facebook', 'meta-auth', 'fb-login'] },
  { name: 'Instagram', primaryDomain: 'instagram.com', keywords: ['instagram'] },
  { name: 'WhatsApp', primaryDomain: 'whatsapp.com', keywords: ['whatsapp'] },
